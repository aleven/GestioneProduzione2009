...
Public Class frmConfiguratoreGruppi
...
#Region " Windows Form Designer generated code "
    ...
    Friend WithEvents txtCodGruppo As System.Windows.Forms.TextBox
    Friend WithEvents txtDescrizioneGruppo As System.Windows.Forms.TextBox
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Me.components = New System.ComponentModel.Container
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(frmConfiguratoreGruppi))
        Me.lblCodGruppo = New System.Windows.Forms.Label
        Me.Label2 = New System.Windows.Forms.Label
        Me.btnSceltaGruppo = New System.Windows.Forms.Button
        Me.txtCodGruppo = New System.Windows.Forms.TextBox
        Me.txtDescrizioneGruppo = New System.Windows.Forms.TextBox
        ...
        Me.lblCodGruppo.Text = "Codice Gruppo :"
        '
        'Label2
        '
        ...
        Me.Label2.Text = "Descrizione Gruppo :"
        '
        'btnSceltaGruppo
        '
        ...
        Me.btnSceltaGruppo.Size = New System.Drawing.Size(96, 32)
        Me.btnSceltaGruppo.TabIndex = 2
        Me.btnSceltaGruppo.Text = "Seleziona"
        Me.ToolTip1.SetToolTip(Me.btnSceltaGruppo, "Ricerca e selezione gruppo")
        '
        'txtCodGruppo
        '
        Me.txtCodGruppo.Location = New System.Drawing.Point(128, 16)
        Me.txtCodGruppo.Name = "txtCodGruppo"
        Me.txtCodGruppo.ReadOnly = True
        Me.txtCodGruppo.Size = New System.Drawing.Size(184, 20)
        Me.txtCodGruppo.TabIndex = 1
        Me.txtCodGruppo.TabStop = False
        Me.ToolTip1.SetToolTip(Me.txtCodGruppo, "Codice Gruppo (F9=Ricerca, F10=Nuovo)")
        '
        'txtDescrizioneGruppo
        '
        Me.txtDescrizioneGruppo.Anchor = CType(((System.Windows.Forms.AnchorStyles.Top Or System.Windows.Forms.AnchorStyles.Left) _
                    Or System.Windows.Forms.AnchorStyles.Right), System.Windows.Forms.AnchorStyles)
        Me.txtDescrizioneGruppo.Location = New System.Drawing.Point(128, 48)
        Me.txtDescrizioneGruppo.Multiline = True
        Me.txtDescrizioneGruppo.Name = "txtDescrizioneGruppo"
        Me.txtDescrizioneGruppo.ReadOnly = True
        Me.txtDescrizioneGruppo.Size = New System.Drawing.Size(744, 48)
        Me.txtDescrizioneGruppo.TabIndex = 7
        Me.txtDescrizioneGruppo.TabStop = False
        '
        'conn1
        '
        ...
        Me.DataGridArticoliGruppi.Anchor = CType((((System.Windows.Forms.AnchorStyles.Top Or System.Windows.Forms.AnchorStyles.Bottom) _
                    ...
                    Or System.Windows.Forms.AnchorStyles.Right), System.Windows.Forms.AnchorStyles)
        Me.DataGridArticoliGruppi.CaptionText = "Articoli/Gruppi appartenenti al Gruppo"
        ...
        Me.btnChiudi.Location = New System.Drawing.Point(744, 496)
        ...
        Me.btnNuovoGruppo.Location = New System.Drawing.Point(424, 8)
        ...
        Me.ToolTip1.SetToolTip(Me.btnNuovoGruppo, "Nuovo gruppo")
        '
        'btnEliminaGruppo
        '
        ...
        Me.btnEliminaGruppo.Location = New System.Drawing.Point(632, 8)
        ...
        Me.ToolTip1.SetToolTip(Me.btnEliminaGruppo, "Elimina gruppo")
        '
        'btnModificaGruppo
        '
        ...
        Me.btnModificaGruppo.Location = New System.Drawing.Point(528, 8)
        ...
        Me.ToolTip1.SetToolTip(Me.btnModificaGruppo, "Modifica gruppo")
        '
        'frmConfiguratoreGruppi
        '
        ...
        Me.Controls.Add(Me.txtDescrizioneGruppo)
        Me.Controls.Add(Me.txtCodGruppo)
        ...
        Me.Name = "frmConfiguratoreGruppi"
        Me.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen
        Me.Text = "Configuratore Gruppi"
...
#End Region
    ...
    Private Sub btnSceltaGruppo_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSceltaGruppo.Click
        ...
        Dim FormSceltaGruppo As New frmSceltaGruppo
        FormSceltaGruppo.ShowDialog()

        If FormSceltaGruppo.IDGruppo <> -1 Then

            mintIDArticoloCorrente = FormSceltaGruppo.IDGruppo()
            Me.txtCodGruppo.Text = FormSceltaGruppo.CodGruppo
            Me.txtDescrizioneGruppo.Text = FormSceltaGruppo.DescrizioneGruppo

            Call CaricaDatiGruppo()
            Call RicalcolaPosizioniGruppo()
    ...
    Private Sub InitGruppo()
        ...
        Me.txtCodGruppo.Text = ""
        Me.txtDescrizioneGruppo.Text = ""
        ...
        Me.DataGridArticoliGruppi.TableStyles(0).MappingName = "t22_articoli_articoli"
    ...
    Private Sub AggiungiArticoli()
                ...
                If DataGridArticoli.IsSelected(intRowCount) Then
                    ...
                    Else
                        ...
                        ElseIf ArticoloConFigli(mintIDArticoloDaAggiungere, mintIDArticoloCorrente) Then
                            ...
                            mstrMsg = "Impossibile inserire il gruppo in quanto esso ha almeno un gruppo 'figlio' uguale al gruppo che si sta configurando!"
                            MessageBox.Show(mstrMsg, Me.Text, MessageBoxButtons.OK, MessageBoxIcon.Information)
        ...
        If Not (strCodArticolo Is Nothing) Then
            mstrMsg = "I seguenti articoli o gruppi :" & vbCrLf & vbCrLf
    ...
    Private Function GruppoGiaPresente(ByVal intIDGruppoFiglio As Integer, ByVal intIDGruppo As Integer) As Boolean
        ...
        mstrSQL = "SELECT * FROM t22_articoli_articoli WHERE "
        mstrSQL = mstrSQL & "t22_id_articolo_t20 = " & intIDGruppoFiglio.ToString & " AND "
        mstrSQL = mstrSQL & "t22_id_articolo_padre_t20 = " & intIDGruppo.ToString & " AND "
        mstrSQL = mstrSQL & "t22_dt_cancellazione IS NULL"
    ...
    Private Sub CaricaDatiGruppo()
        ...
        If DRIstanze.HasRows Then
            MessageBox.Show("ATTENZIONE! Il gruppo che si sta richiamando appartiene ad una macchina istanziata in produzione o sospesa!", Me.Text, MessageBoxButtons.OK, MessageBoxIcon.Information)
        End If
    ...
    Private Sub RicalcolaPosizioniGruppo()
    ...
    Private Sub btnSpostaSu_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSpostaSu.Click
        ...
        If objdsArticoliGruppi.Tables("t22_articoli_articoli").Rows.Count <= 0 Then 't02_articoli_gruppi
            MessageBox.Show("Nessun gruppo memorizzato all'interno del gruppo selezionato!", Me.Text, MessageBoxButtons.OK, MessageBoxIcon.Information)
            Exit Sub
        End If
    ...
    Private Sub btnNuovoGruppo_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnNuovoGruppo.Click
        ...
        FormInsGruppo.ConnectionString = conn1.ConnectionString
    ...
    Private Sub btnModificaGruppo_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnModificaGruppo.Click
        ...
        'TODO: XX caricare i dati dopo modifica
        Me.txtCodGruppo.Text = FormInsGruppo.Codice
        Me.txtDescrizioneGruppo.Text = FormInsGruppo.Descrizione
    ...
    Private Sub btnEliminaGruppo_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnEliminaGruppo.Click
        ...
        If MessageBox.Show("Confermi eliminazione gruppo?", Me.Text, MessageBoxButtons.YesNo, MessageBoxIcon.Question) = DialogResult.Yes Then
    ...
    Private Sub txtCodGruppo_KeyDown(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles txtCodGruppo.KeyDown
        If e.KeyValue = Keys.F9 Then
            Call btnSceltaGruppo_Click(txtCodGruppo, Nothing)
        ElseIf e.KeyValue = Keys.F10 Then
            Call btnNuovoGruppo_Click(txtCodGruppo, Nothing)
        End If
    End Sub

    Private Sub conn_InfoMessage(ByVal sender As System.Object, ByVal e As System.Data.SqlClient.SqlInfoMessageEventArgs) Handles conn1.InfoMessage
