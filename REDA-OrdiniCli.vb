...
Public Class REDA_OrdiniCli
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "GestioneProduzione.REDA-OrdiniCli.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedREDA_OrdiniCli
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As REDA_OrdiniCli = New REDA_OrdiniCli
        rpt.Site = Me.Site
        Return rpt
    End Function
