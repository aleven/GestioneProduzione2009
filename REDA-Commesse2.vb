...
Public Class REDA_Commesse2
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "GestioneProduzione.REDA-Commesse2.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedREDA_Commesse2
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As REDA_Commesse2 = New REDA_Commesse2
        rpt.Site = Me.Site
        Return rpt
    End Function
