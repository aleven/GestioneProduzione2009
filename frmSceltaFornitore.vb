Public Class frmSceltaFornitore
...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(frmSceltaFornitore))
        ...
        Me.DataGridTableStyle1.MappingName = "t11_fornitori"
        '
        ...
        Me.DataGridTextBoxColumn1.MappingName = "t11_id_fornitore"
        ...
        Me.DataGridTextBoxColumn2.HeaderText = "Codice Fornitore"
        Me.DataGridTextBoxColumn2.MappingName = "t11_cod_fornitore"
        ...
        Me.DataGridTextBoxColumn3.HeaderText = "Descrizione Fornitore"
        Me.DataGridTextBoxColumn3.MappingName = "t11_descrizione"
        ...
        Me.SqlDataAdapter1.TableMappings.AddRange(New System.Data.Common.DataTableMapping() {New System.Data.Common.DataTableMapping("Table", "t11_fornitori", New System.Data.Common.DataColumnMapping() {New System.Data.Common.DataColumnMapping("t11_id_fornitore", "t11_id_fornitore"), New System.Data.Common.DataColumnMapping("t11_cod_fornitore", "t11_cod_fornitore"), New System.Data.Common.DataColumnMapping("t11_descrizione", "t11_descrizione"), New System.Data.Common.DataColumnMapping("t11_telefono", "t11_telefono"), New System.Data.Common.DataColumnMapping("t11_note", "t11_note"), New System.Data.Common.DataColumnMapping("t11_dt_creazione", "t11_dt_creazione"), New System.Data.Common.DataColumnMapping("t11_dt_modifica", "t11_dt_modifica"), New System.Data.Common.DataColumnMapping("t11_dt_cancellazione", "t11_dt_cancellazione")})})
        ...
        Me.Name = "frmSceltaFornitore"
        Me.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen
        Me.Text = "Lista Fornitori"
...
#End Region
    ...
    Private Sub frmSceltaFornitore_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Me.conn1.ConnectionString = frmMain.ConnectionString

        mintIDFornitore = -1
        SqlDataAdapter1.Fill(objListaFornitori)
    ...
    Private Sub ApplicaFiltri(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles txtRicercaCodice.TextChanged, txtRicercaDescrizione.TextChanged
        ...
        If strFiltroCodice.Trim <> "" Then
            strFiltro = "t11_cod_fornitore LIKE '*" & strFiltroCodice & "*' "
            If strFiltroDescrizione.Trim <> "" Then
                strFiltro = strFiltro & "AND "
                strFiltro = strFiltro & "t11_descrizione LIKE '*" & strFiltroDescrizione & "*'"
            End If
        Else
            If strFiltroDescrizione.Trim <> "" Then
                strFiltro = "t11_descrizione LIKE '*" & strFiltroDescrizione & "*'"
            End If
        End If
