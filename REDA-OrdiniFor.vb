...
Public Class REDA_OrdiniFor
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "GestioneProduzione.REDA-OrdiniFor.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedREDA_OrdiniFor
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As REDA_OrdiniFor = New REDA_OrdiniFor
        rpt.Site = Me.Site
        Return rpt
    End Function
