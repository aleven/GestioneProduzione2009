...
Public Class REDA_Commesse
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "GestioneProduzione.REDA-Commesse.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedREDA_Commesse
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As REDA_Commesse = New REDA_Commesse
        rpt.Site = Me.Site
        Return rpt
    End Function
