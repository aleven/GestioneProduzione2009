...
Public Class TEMAC_OrdiniFor
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "GestioneProduzione.TEMAC-OrdiniFor.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedTEMAC_OrdiniFor
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As TEMAC_OrdiniFor = New TEMAC_OrdiniFor
        rpt.Site = Me.Site
        Return rpt
    End Function
