...
Public Class REDA_OrdineVendita
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "GestioneProduzione.REDA-OrdineVendita.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedREDA_OrdineVendita
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As REDA_OrdineVendita = New REDA_OrdineVendita
        rpt.Site = Me.Site
        Return rpt
    End Function
