...
Public Class REDA_Listino
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "GestioneProduzione.REDA-Listino.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedREDA_Listino
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As REDA_Listino = New REDA_Listino
        rpt.Site = Me.Site
        Return rpt
    End Function
