...
Public Class frmOrdiniRicambiElenco

    Private Const VIEW_OPEN As String = "Mostra solo Ordini Aperti"
    Private Const VIEW_CLOSE As String = "Mostra solo Ordini Evasi"
    Private Const VIEW_ALL As String = "Mostra tutti gli Ordini"
    ...
    Private Sub CaricaDatiAccessori()
        ...
        Me.cmbFiltroAnno.DataSource = Me.T28_anni.GetData()
    ...
    Private Sub CaricaDati()
        ...
        Me.T28_testate_ordini_cliTableAdapter.Fill(Me.GestioneProduzione2009DataSet.t28_testate_ordini_cli)
    ...
    Private Sub FiltraDati()
        ...
        If (datiCaricati) Then
            ...
            If (cmbFiltroVista.SelectedItem = VIEW_OPEN) Then
                strFiltro.Append(" AND t28_stato_testata_ordine = 'A'")
            ElseIf cmbFiltroVista.SelectedItem = VIEW_CLOSE Then
                strFiltro.Append(" AND t28_stato_testata_ordine = 'E'")
            Else
            ...
            If (Not LangUtils.isEmpty(cmbFiltroAnno.SelectedValue)) Then
                ...
                strFiltro.Append(String.Format(" AND (t28_commessa_del >= #{0:yyyy-MM-dd}# AND t28_commessa_del <= #{1:yyyy-MM-dd}#)", VS2005Commons.DateUtils.getYearStart(annoSelezionato), VS2005Commons.DateUtils.getYearEnd(annoSelezionato)))
            End If
            ...
            If StringUtils.isNotEmpty(txtSemeRicerca.Text) Then
                ...
                strFiltro.Append(" OR " & QueryUtils.likeCondition2(T28cliente2DataGridViewTextBoxColumn.DataPropertyName, seme))
                ...
                strFiltro.Append(" OR " & QueryUtils.likeCondition2(T28rifredaDataGridViewTextBoxColumn.DataPropertyName, seme))
                strFiltro.Append(" OR " & QueryUtils.likeCondition2(T28rifordineDataGridViewTextBoxColumn.DataPropertyName, seme))
                strFiltro.Append(" )")
            End If
    ...
    Private Sub DataGridView1_DoubleClick(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles DataGridView1.DoubleClick
        ...
        If id > 0 Then
            ...
            Else
                Dim frmOrdine As New frmOrdiniRicambiNuovo
                frmOrdine.IDOrdine = id
                frmOrdine.FormChiamante = Me
                frmOrdine.MdiParent = Me.MdiParent
                frmOrdine.Show()
