...
Public Class REDA_Articoli
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "GestioneProduzione.REDA-Articoli.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedREDA_Articoli
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As REDA_Articoli = New REDA_Articoli
        rpt.Site = Me.Site
        Return rpt
    End Function
