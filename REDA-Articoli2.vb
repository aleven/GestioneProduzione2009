...
Public Class REDA_Articoli2
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "GestioneProduzione.REDA-Articoli2.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedREDA_Articoli2
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As REDA_Articoli2 = New REDA_Articoli2
        rpt.Site = Me.Site
        Return rpt
    End Function
